! function(c, M) {
    ...
    function l() {
        ...
        var A, o, z, b = function() {
                var c, M, A, o = (new Date).getFullYear() - 2,
            ...
            a = b.length,
            p = function(c) {
                var M, A, o, z = c.length,
                    b = {},
                    a = [];
                for (M = 0; M < z; M++)
                    for (A in o = e[c[M].offset] || {}) o.hasOwnProperty(A) && (b[A] = !0);
    ...
    function m(c) {
        t(c.zones), E(c.links),
            function(c) {
                var M, A, o, z;
                if (c && c.length)
                    for (M = 0; M < c.length; M++) A = (z = c[M].split("|"))[0].toUpperCase(), o = z[1].split(" "), n[A] = new d(A, o)
    ...
    function R(c) {
        ...
        parse: function(c) {
            var M, A, o, z, b = +c,
                ...
                n = p.length - 1;
            for (z = 0; z < n; z++)
                if (M = a[z], A = a[z + 1], o = a[z ? z - 1 : z], M < A && R.moveAmbiguousForward ? M = A : o < M && R.moveInvalidForward && (M = o), b < p[z] - 6e4 * M) return a[z];
            return a[n]
        },
        abbr: function(c) {
    ...
    b.tz = R, b.defaultZone = null, b.updateOffset = function(c, M) {
        var A, o = b.defaultZone;
        if (void 0 === c._z && (o && C(c) && !c._isUTC && (c._d = b.utc(c._a)._d, c.utc().add(o.parse(c), "minutes")), c._z = o), c._z)
            if (A = c._z.utcOffset(c), Math.abs(A) < 16 && (A /= 60), void 0 !== c.utcOffset) {
                var z = c._z;
